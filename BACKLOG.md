...
| A20 | H-M1 开源接力观察（观察窗 2026-08-15 → 2027-02-15） | HYPOTHESES H-M1；BLUEPRINT §3/G4 | in_progress | 预注册判据：≥1 名持 GPU 外部研究者 fork/PR 并执行 M3 评测（或同类）；**首观察 2026-08-17：0 star / 0 fork / 0 issue（GitHub API）**；持续观察至 2027-02 |
...
| A30 | H-T1/H-T5 预注册 + C9 正式轮工作表 + 蓝图 §7.10（真实数据就绪前冻结口径/流程） | 决策记录 2026-08-17 | done | **完成**：H-T1（等值线斜率比 >10×，D-full 门控）、H-T5（对数曲线 R²>0.9 + 边际判定）→ preregistered；`C9_正式轮观察工作表_2026-11-15.md`；BLUEPRINT v2.7 §7.10；执行待真实数据/C9 正式轮 |
